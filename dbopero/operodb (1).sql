...
--
-- Host: 127.0.0.1
-- Creato il: Set 13, 2025 alle 10:03
...
--
-- RELAZIONI PER TABELLA `an_relazioni`:
--
...
--
-- RELAZIONI PER TABELLA `an_tipi_relazione`:
--
...
--
-- RELAZIONI PER TABELLA `app_funzioni`:
--   `codice_modulo`
--       `moduli` -> `codice`
--
...
--
-- RELAZIONI PER TABELLA `app_ruoli`:
--   `codice_modulo`
--       `moduli` -> `codice`
--
...
--
-- RELAZIONI PER TABELLA `app_ruoli_funzioni`:
--   `id_ruolo`
--       `app_ruoli` -> `id`
--   `id_funzione`
--       `app_funzioni` -> `id`
...
--
-- RELAZIONI PER TABELLA `ditta_mail_accounts`:
--
...
--
-- RELAZIONI PER TABELLA `ditte`:
--   `id_tipo_ditta`
--       `tipo_ditta` -> `id`
--   `codice_relazione`
--       `relazioni_ditta` -> `codice`
--   `id_sottoconto_cliente`
--       `sc_piano_dei_conti` -> `id`
--   `id_sottoconto_fornitore`
--       `sc_piano_dei_conti` -> `id`
--   `id_sottoconto_puntovendita`
--       `sc_piano_dei_conti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `ditte_moduli`:
--   `codice_modulo`
--       `moduli` -> `codice`
--
...
--
-- RELAZIONI PER TABELLA `email_inviate`:
--   `id_utente_mittente`
--       `utenti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `email_nascoste`:
--   `id_utente`
--       `utenti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `funzioni`:
--   `chiave_componente_modulo`
--       `moduli` -> `chiave_componente`
--
...
--
-- RELAZIONI PER TABELLA `knex_migrations`:
--
...
--
-- RELAZIONI PER TABELLA `knex_migrations_lock`:
--
...
--
-- RELAZIONI PER TABELLA `lista_distribuzione_ditte`:
--   `id_lista`
--       `liste_distribuzione` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `lista_distribuzione_utenti`:
--   `id_lista`
--       `liste_distribuzione` -> `id`
--   `id_utente`
--       `utenti` -> `id`
...
--
-- RELAZIONI PER TABELLA `liste_distribuzione`:
--
...
--
-- RELAZIONI PER TABELLA `log_accessi`:
--   `id_utente`
--       `utenti` -> `id`
--   `id_funzione_accessibile`
--       `funzioni` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `log_azioni`:
--   `id_utente`
--       `utenti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `ppa_azioni`:
--   `ID_Processo`
--       `ppa_processi` -> `ID`
--   `ID_RuoloDefault`
--       `ruoli` -> `id`
...
--
-- RELAZIONI PER TABELLA `ppa_istanzeazioni`:
--   `ID_IstanzaProcedura`
--       `ppa_istanzeprocedure` -> `ID`
--   `ID_Azione`
--       `ppa_azioni` -> `ID`
--   `ID_UtenteAssegnato`
--       `utenti` -> `id`
...
--
-- RELAZIONI PER TABELLA `ppa_istanzeprocedure`:
--   `ID_ProceduraDitta`
--       `ppa_procedureditta` -> `ID`
--   `ID_UtenteCreatore`
--       `utenti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `ppa_procedureditta`:
--   `ID_ProceduraStandard`
--       `ppa_procedurestandard` -> `ID`
--
...
--
-- RELAZIONI PER TABELLA `ppa_procedurestandard`:
--
...
--
-- RELAZIONI PER TABELLA `ppa_processi`:
--   `ID_ProceduraDitta`
--       `ppa_procedureditta` -> `ID`
--
...
--
-- RELAZIONI PER TABELLA `ppa_stati_azione`:
--
...
--
-- RELAZIONI PER TABELLA `ppa_team`:
--   `ID_IstanzaProcedura`
--       `ppa_istanzeprocedure` -> `ID`
--
...
--
-- RELAZIONI PER TABELLA `ppa_teammembri`:
--   `ID_Team`
--       `ppa_team` -> `ID`
--   `ID_Utente`
--       `utenti` -> `id`
...
--
-- RELAZIONI PER TABELLA `privacy_policies`:
--
...
--
-- RELAZIONI PER TABELLA `registration_tokens`:
--
...
--
-- RELAZIONI PER TABELLA `relazioni_ditta`:
--
...
--
-- RELAZIONI PER TABELLA `ruoli_funzioni`:
--   `id_ruolo`
--       `ruoli` -> `id`
--   `id_funzione`
--       `funzioni` -> `id`
...
--
-- RELAZIONI PER TABELLA `sc_funzioni_collegate`:
--   `id_funzione_primaria`
--       `sc_funzioni_contabili` -> `id`
--   `id_funzione_secondaria`
--       `sc_funzioni_contabili` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `sc_funzioni_collegate_mapping`:
--   `id_funzione_collegata`
--       `sc_funzioni_collegate` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `sc_funzioni_contabili`:
--
...
--
-- RELAZIONI PER TABELLA `sc_funzioni_contabili_righe`:
--   `id_funzione_contabile`
--       `sc_funzioni_contabili` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `sc_movimenti_iva`:
--
...
--
-- RELAZIONI PER TABELLA `sc_partite_aperte`:
--
...
--
-- RELAZIONI PER TABELLA `sc_piano_dei_conti`:
--   `id_padre`
--       `sc_piano_dei_conti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `sc_registrazioni_righe`:
--   `id_testata`
--       `sc_registrazioni_testata` -> `id`
--   `id_conto`
--       `sc_piano_dei_conti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `sc_registrazioni_testata`:
--   `id_utente`
--       `utenti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `sc_registri_iva`:
--   `id_riga_registrazione`
--       `sc_registrazioni_righe` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `sottoconti`:
--   `id_conto`
--       `conti` -> `id`
--
...
--
-- RELAZIONI PER TABELLA `tipi_pagamento`:
--
...
--
-- RELAZIONI PER TABELLA `tipi_utente`:
--
...
--
-- RELAZIONI PER TABELLA `tipo_ditta`:
--
...
--
-- RELAZIONI PER TABELLA `utente_scorciatoie`:
--   `id_utente`
--       `utenti` -> `id`
--   `id_funzione`
--       `funzioni` -> `id`
